...
Public Class PouchReport_BasedOnPlan
    ...
    End Sub
    Private Sub GetPMMA_Pouch_Report()
        Dim dt As DataTable
        ...
        dt = PMMA_Excel_cls.GetExcelReport_Pouch(cmbYear.Text, cmbMonth.Text)
        DataGridView1.DataSource = dt
    End Sub

    Private Sub GetPHILIC_Pouch_Report()
        Dim dt As DataTable
        ...
        dt = PHILIC_Excel_cls.GetExcelReport_Pouch(cmbYear.Text, cmbMonth.Text)
        DataGridView1.DataSource = dt
    End Sub

    Private Sub GetPHOBIC_Pouch_Report()
        Dim dt As DataTable
        ...
        dt = PHOBIC_Excel_cls.GetExcelReport_Pouch(cmbYear.Text, cmbMonth.Text)
        DataGridView1.DataSource = dt
    End Sub
    ...
    Private Sub btn_download_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_download.Click
        ...
        Dim excelFilePath As String = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\" + cmb_Product_Type.Text + "_POUCH_REPORT_" + DateTime.Now().ToString("yyyy_MM_dd_HH_mm_ss") + ".xlsx"
