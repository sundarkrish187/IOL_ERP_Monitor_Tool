...
Public Class Production_Report_BasedOnPlan
    ...
    End Sub
    Private Sub GetPMMA_Production_Report()
        Dim dt As DataTable
        ...
        dt = PMMA_Excel_cls.GetExcelReport_Production(cmbYear.Text, cmbMonth.Text)
        DataGridView1.DataSource = dt
    End Sub

    Private Sub GetPHILIC_Production_Report()
        Dim dt As DataTable
        ...
        dt = PHILIC_Excel_cls.GetExcelReport_Production(cmbYear.Text, cmbMonth.Text)

        DataGridView1.DataSource = dt
    End Sub

    Private Sub GetPHOBIC_Production_Report()
        Dim dt As DataTable
        ...
        dt = PHOBIC_Excel_cls.GetExcelReport_Production(cmbYear.Text, cmbMonth.Text)
        DataGridView1.DataSource = dt
    ...
    Private Sub Production_Report()
        ...
        If cmb_Product_Type.Text = "PHILIC" Then
            GetPHILIC_Production_Report()
        ElseIf cmb_Product_Type.Text = "PHOBIC" Then
            GetPHOBIC_Production_Report()
        ElseIf cmb_Product_Type.Text = "PMMA" Then
            GetPMMA_Production_Report()
        End If
    ...
    Private Sub btn_download_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_download.Click
        ...
        Dim excelFilePath As String = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\" + cmb_Product_Type.Text + "_PRODUCTION_REPORT_" + DateTime.Now().ToString("yyyy_MM_dd_HH_mm_ss") + ".xlsx"
    ...
    Private Sub btn_View_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_View.Click
        ...
        comboDate = dtpdate_from.Value
        cmpTodate = dtpdate_to.Value
    ...
    Private Sub chBx_date_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chBx_date.CheckedChanged
        ...
        If chBx_date.Checked = True Then
            ...
            dtpdate_from.Visible = True
            dtpdate_to.Visible = True
        Else
            Label4.Visible = False
            Label5.Visible = True
            CmbDate.Visible = False
            ToDate.Visible = False
            dtpdate_from.Visible = False
            dtpdate_to.Visible = False
        End If
    End Sub
End Class